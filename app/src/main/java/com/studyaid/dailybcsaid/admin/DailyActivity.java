...
public class DailyActivity extends  AppCompatActivity  { 
	...
	private DatabaseReference Daily = _firebase.getReference("Questions/Daily");
	private ChildEventListener _Daily_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_Daily_child_listener = new ChildEventListener() {
			@Override
		...
		Daily.addChildEventListener(_Daily_child_listener);
	}
